async function downloadformTutorial(){
    ...
    async function downloadform() {
      ...
      // Add name field to PDF
      const nameField = pdfDoc.getForm().createTextField('name');
      nameField.addToPage(page, { x: 56, y: 618, width: 200, height: 20 }); 
      nameField.setFontSize(12);

      nameField.setFont(font);
      // Hide the name field when printing the PDF
      nameField.updateAppearances({ borderColor: [0, 0, 0], borderWidth: 0, borderStyle: 'solid' });
